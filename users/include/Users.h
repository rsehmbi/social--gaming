...
public:
    //Default Constructor
    Users(std::string playername,int playerNum, int PlayerID, bool isOwner, int NumOfWins ): playerName(playername)
            ,playerNum(playerNum),playerID(PlayerID),isOwner(isOwner),NumOfWins(NumOfWins){};
